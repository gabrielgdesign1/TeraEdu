    ...
    <div className="min-h-screen bg-[#0f1117] flex">
      ...
      <aside className="w-64 bg-[#1a1d27] border-r border-[#2a2d3a] flex flex-col fixed h-full">
        ...
        <nav className="flex flex-col gap-1 px-3 py-4 flex-1">
          ...
          <a href="#" className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-[#8b8fa8] hover:text-white hover:bg-[#2a2d3a] text-sm transition-colors">
              ...
              {[
                ...
                <div key={m.nome} className="bg-[#0f1117] rounded-xl p-4 cursor-pointer hover:border hover:border-[#2563eb] transition-all">
                  ...
                  <div className="h-1.5 bg-[#2a2d3a] rounded-full">
                    <div className="h-1.5 rounded-full transition-all" style={{ width: `${m.progresso}%`, backgroundColor: m.cor }}></div>
                  </div>
                </div>
              ))}
            </div>
